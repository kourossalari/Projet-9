...
const Page = () => {
  const {data} = useData()
  const last = data?.events ? [...data.events].sort((a,b) => new Date(a.date) - new Date(b.date))[0] : null
  return <>
    <header>
      <Menu />
    </header>
    <main>
      ...
      <section className="ServicesContainer" id="nos-services">
        ...
        <div className="ListContainer">
          <ServiceCard imageSrc="/images/priscilla-du-preez-Q7wGvnbuwj0-unsplash1.webp">
          ...
          <ServiceCard imageSrc="/images/hall-expo.webp">
            <h3>Conférences</h3>
          ...
          <ServiceCard imageSrc="/images/sophia-sideri-LFXMtUuAKK8-unsplash1.webp">
      ...
      <section className="PeoplesContainer" id="notre-equipe">
        ...
        <div className="ListContainer">
          <PeopleCard
            imageSrc="/images/stephanie-liverani-Zz5LQe-VSMY-unsplash.webp"
            name="Samira"
            position="CEO"
          />
          <PeopleCard
            imageSrc="/images/linkedin-sales-solutions-pAtA8xe_iVM-unsplash.webp"
            name="Jean-baptiste"
            position="Directeur marketing"
          />
          <PeopleCard
            imageSrc="/images/christina-wocintechchat-com-SJvDxw0azqw-unsplash.webp"
            name="Alice"
            position="CXO"
          />
          <PeopleCard
            imageSrc="/images/jonas-kakaroto-KIPqvvTOC1s-unsplash.webp"
            name="Luís"
            position="Animateur"
          />
          <PeopleCard
            imageSrc="/images/amy-hirschi-b3AYk8HKCl0-unsplash1.webp"
            name="Christine"
            position="VP animation"
          />
          <PeopleCard
            imageSrc="/images/christina-wocintechchat-com-0Zx1bDv5BNY-unsplash.webp"
            name="Isabelle"
